...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "-l", "--left", type=str, required=True, help="Comma-separated list of left reads in an paired set"
    )
    parser.add_argument(
        "-r", "--right", type=str, required=True, help="Comma-separated list of right reads in an paired set"
    )
